              ...
              <div className="flex justify-between items-center pb-4 mb-6 border-b border-white/[0.05]">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M13.483 0a1.37 1.37 0 0 0-.961.438L7.116 6.226l-3.854 4.126a5.3 5.3 0 0 0-1.209 2.104a5 5 0 0 0-.125.513a5.5 5.5 0 0 0 .062 2.362a6 6 0 0 0 .349 1.017a5.9 5.9 0 0 0 1.271 1.818l4.277 4.193l.039.038c2.248 2.165 5.852 2.133 8.063-.074l2.396-2.392c.54-.54.54-1.414.003-1.955a1.38 1.38 0 0 0-1.951-.003l-3.48 3.529a1.37 1.37 0 0 0-.355 1.442a1.37 1.37 0 0 0 1.053.967c.209.042.423.063.636.063c.895 0 1.742-.477 2.213-.948l3.595-3.473c.624-0.625 1.484-0.885 2.432-0.885s1.807 0.26 2.432 0.885l5.776 5.812c.62 0.625.937 1.537.937 2.485c0 0.952-.317 1.812-.937 2.432l-5.76 5.844c-.62 0.619-1.5 0.859-2.448 0.859s-1.808-.26-2.432-.885l-3.595-3.473c-.687-.688-1.823-.663-2.536 0.052c-.708.713-.735 1.848-.047 2.536l3.473 3.511c.901 0.891 2.032 1.505 3.261 1.787l-3.287 3.333c-.688.687-.667 1.823 0.047 2.536s1.849 0.735 2.536 0.052l13.469-13.469c1.307-1.312 1.989-3.113 1.989-5.113c0-1.996-.683-3.86-1.989-5.168l-5.797-5.812c-1.307-1.307-3.115-1.937-5.115-1.937c-1.995 0-3.801 0.683-5.109 1.989l-3.479 3.521c-.688.683-.661 1.817 0.052 2.531s1.849 0.74 2.531 0.052z"/>
                  </svg>
                </a>
              </div>
          ...
          >
            ...
            <div className="tilt-content relative z-10">
              ...
              <div className="flex justify-between items-center pb-4 mb-6 border-b border-white/[0.05]">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 0L2.88 5.25v13.5L12 24l9.12-5.25V5.25L12 0zm0 2.584l6.837 3.946v7.887L12 18.363l-6.837-3.946V6.53L12 2.584zm0 5.485l-3.328 1.921v3.842L12 15.753l3.328-1.921v-3.842L12 8.069z"/>
                  </svg>
                </a>
              </div>
