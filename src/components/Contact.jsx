...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("access_key", "3b995d71-69db-461d-886e-0b687c45ee18");
  ...
  const contact_info = [
    { 
      label: "Email", 
      value: "parthsharma240404@gmail.com", 
      href: "mailto:parthsharma240404@gmail.com",
      icon: (
    ...
    { 
      ...
      href: "https://www.linkedin.com/in/parth-sharma-24p/",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    { 
      ...
      href: "https://github.com/ParthSharma2404",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="lg:col-span-2 space-y-4">
            {contact_info.map((info, index) => (
              ...
              >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-600 group-hover:text-accent group-hover:translate-x-1 transition-all">
          ...
          <div className="lg:col-span-3 bg-zinc-900/30 border border-zinc-800 p-8 md:p-12 rounded-[2rem] reveal reveal-delay-300">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-800 rounded-2xl p-4 text-white outline-none focus:border-white transition-colors"
                  required
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows="5"
                className="w-full bg-zinc-900 border border-zinc-800 rounded-2xl p-4 text-white outline-none focus:border-white transition-colors resize-none"
                required
              />
            </div>
            ...
            {status === "success" && (
              <p className="text-accent text-sm font-medium text-center animate-bounce">
